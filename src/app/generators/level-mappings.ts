...
export class LevelMappings {
  static readonly SHIP_META: Record<ShipType, LevelMapping> = {
    ...
    [ShipType.ATMOSPHERIC_FIGHTER]: { availableFromLevel: 2, weight: 2 },
    [ShipType.ATMOSPHERIC_BOMBER]: { availableFromLevel: 3, weight: 3 },
    ...
    [ShipType.TRANSPORTER]: { availableFromLevel: 3, weight: 3 },
    [ShipType.BATTLE_CRUISER]: { availableFromLevel: 6, weight: 5 },
    [ShipType.DESTROYER]: { availableFromLevel: 6, weight: 5 },
    [ShipType.DREADNOUGHT]: { availableFromLevel: 6, weight: 5 },
    [ShipType.ORBITAL_BOMBER]: { availableFromLevel: 7, weight: 6 },
    [ShipType.CARRIER]: { availableFromLevel: 6, weight: 6 },
    [ShipType.CARGO_SUPPORT]: { availableFromLevel: 5, weight: 5 },
    [ShipType.MASS_HAULER]: { availableFromLevel: 5, weight: 5 },
    [ShipType.COLONIZER]: { availableFromLevel: 4, weight: 6 },
    [ShipType.TITAN]: { availableFromLevel: 7, weight: 7 },
    [ShipType.ARMAGEDDON_BOMBER]: { availableFromLevel: 8, weight: 9 },
    [ShipType.BEHEMOTH]: { availableFromLevel: 7, weight: 8 },
    [ShipType.FLEET_CARRIER]: { availableFromLevel: 8, weight: 9 },
    [ShipType.MOTHER_SHIP]: { availableFromLevel: 10, weight: 12 },
  } as const;
