...
export const STARTING_HOMEWORLD_PRESET_TOOLTIPS: Record<StartingHomeworldPreset, string> = {
  ...
  [StartingHomeworldPreset.MEDIUM]: [
    ...
    'Tech: Fusion Drive 1, Hyperspace Drive 1, Espionage Technology 1.',
  ...
  [StartingHomeworldPreset.HIGH]: [
    ...
    'Tech: Fusion Drive 1, Hyperspace Drive 1, Computer Technology 1, Espionage Technology 2, Adaptive Technology 1.',
