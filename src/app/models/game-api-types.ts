...
export const MAX_STANDARD_MULTIPLAYER_HUMAN_PLAYERS = 4;
export const MAX_SCHEDULED_MULTIPLAYER_HUMAN_PLAYERS = 10;
export const MIN_SCHEDULED_TURNS_GALAXY_SIZE = 16;
