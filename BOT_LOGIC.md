...
- the current Strategic Diplomatic shadow planner is global and non-mission in phase 1: it tracks only discovered non-neutral players/bots, builds per-faction strength/stance/hostility/confidence evaluations from relations, espionage coverage, and battle-history hints, emits diplomatic relation-change proposals plus incoming/outgoing proposal-management preferences and retaliation flags, and exposes global diplomatic-pressure summary data without yet emitting attacks, support missions, or direct build/ship-demand pressure
